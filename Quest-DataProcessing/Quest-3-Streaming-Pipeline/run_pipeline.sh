...
export AGGREGATE_TABLE_NAME=${PROJECT_ID}:logs.windowed__minute_traffic
export RAW_TABLE_NAME=${PROJECT_ID}:logs.raw_streaming
python $BASE_DIR/Quest-DataProcessing/Quest-2-Batch-Pipeline/minute_traffic_pipeline.py \
--project=${PROJECT_ID} \
--region=${REGION} \
