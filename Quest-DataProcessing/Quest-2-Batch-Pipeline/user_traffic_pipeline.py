...
#Register Coder For PerUserAggregation
...
def run():
    parser = argparse.ArgumentParser(description='Load Json into BigQuery')
    ...
    (p | 'ReadFromGCS' >> beam.io.ReadFromText(input_path)
       ...
       | 'PerUserAggregations' >> beam.GroupBy('user_id') ##Add Aggregation Code
